    ...
    return (
        ...
        `}</style>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.sectionTitle}>BPS wants to simplify ASTA's result navigation</p>
            ...
            <p className={styles.sectionTitle}>Sound libraries are expensive and generic.</p>
            <p className={styles.overviewText}>
               For new and part-time creators, the high cost of sound/music libraries such as Artlist or Epidemic Sounds are often unjustifiable. 
            </p>
            <p className={styles.sectionTag}>Solution</p>
            <p className={styles.sectionTitle}>NeverDMCA provides simple, inexpensive, and more personal music generation using AI.</p>
            <p className={styles.overviewText}>
              NeverDMCA gave users the ability to create personalized music for their content with extremely low and use-adjusted pricing.
            </p>
            <img className={styles.csImgwt} src={Flow1}></img>
            {/* <img className={styles.csImg} src={One}></img> */}

            <p className={styles.sectionTag}>Results</p>
            <p className={styles.sectionTitle}>300+ MAUs.<br/>Partnership with Woody and Kleiny (15M YouTube).</p>
            ...
            <p className={styles.overviewText}>After deciding on a direction, I created user personas to detail the specific goals and pain points that I could address.
            </p>
            ...
            <h6 class={styles.sectionHeader}>Initial Design</h6>
            ...
            <li className={styles.li4} style={{marginTop: 8}}>A simple and prominent call to action to allow users to start a generation with details about how many free generations they have left directly underneath.</li>
           ...
           I did an entire rework of this section to maximize the number of generations visible to the user while making them extremely easy to navigate through.</p>
            ...
            <p className={styles.overviewText}>One of my favorite features I got to develop for NeverDMCA was the in-app video player. This video player allowed for dragging, resizing, a switch in aspect ratio, and volume controls (to change volume relative to the volume of generated music).</p>
