        ...
        <div className={styles.body}>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.overviewText}>
                Working with managing partner David Issac, I collaborated with a software engineer to design and implement a refined, professional, and simplified interface for <a style={{color: "#16243B"}} target="_blank" href="https://www.bpsconsulting.com/asta/">ASTA</a>, a fully autonomous software test agent created by Business Performance Systems (BPS).
            </p>
            <h6 class={styles.sectionHeader}>My Role</h6>
            <p className={styles.overviewText}>My role spanned from design ideation to product execution. Starting with a foundation of design thinking and information architecture, I created high-fidelity mockups for multiple ASTA pages and components using Figma, which I then implemented directly into ASTA using HTML, CSS, JavaScript, and React.</p>
            <h6 class={styles.sectionHeader}>Making massive feel manageable</h6>
            ...
            <p className={styles.imgSubtext}>The users of ASTA were software engineers who needed an efficient way to process errors found on their website.</p>
            ...
            <h6 class={styles.sectionHeader}>Card redesigns</h6>
            ...
            <p style={{marginBottom: -16}} className={styles.overviewText}>To star, I redesigned the "Log Entry" card. This card would display information on an action the testing agent took when evaluating the site given by the user. I focused on reorganizing the information architecture to be more human and intuitive and, in the process, cleaning up the visual design.</p>
