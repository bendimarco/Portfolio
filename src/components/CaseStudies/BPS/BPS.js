    ...
    return (
        <div className={styles.body}>
          ...
          <div className={styles.textContainer}>
            ...
            <p style={{marginBottom: -16}} className={styles.overviewText}>To start, I redesigned the "Log Entry" card. This card would display information on an action the testing agent took when evaluating the site given by the user. I focused on reorganizing the information architecture to be more human and intuitive and, in the process, cleaning up the visual design.</p>
